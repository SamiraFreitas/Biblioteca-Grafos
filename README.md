...
O estudo  de  Grafo  de  Colaborações  em  Pesquisa, trouxe um modelo simplificado para abstrair o problema da vida real, que consiste em, artigos científicos que são produzidos por uma ou mais pessoas é representado pela porcentagem, ou seja, o grau do grafo representa a quantidade de pessoas que publicaram artigos juntos. Através desse algoritmo foi possível observar a distribuição de graus do grafo.
